...
public final class BankServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<stubs.Bank.ConvertCurrencyRequest,
      stubs.Bank.ConvertCurrencyResponse> getConvertMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "convert",
      requestType = stubs.Bank.ConvertCurrencyRequest.class,
      responseType = stubs.Bank.ConvertCurrencyResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<stubs.Bank.ConvertCurrencyRequest,
      stubs.Bank.ConvertCurrencyResponse> getConvertMethod() {
    io.grpc.MethodDescriptor<stubs.Bank.ConvertCurrencyRequest, stubs.Bank.ConvertCurrencyResponse> getConvertMethod;
    if ((getConvertMethod = BankServiceGrpc.getConvertMethod) == null) {
      synchronized (BankServiceGrpc.class) {
        if ((getConvertMethod = BankServiceGrpc.getConvertMethod) == null) {
          BankServiceGrpc.getConvertMethod = getConvertMethod = 
              io.grpc.MethodDescriptor.<stubs.Bank.ConvertCurrencyRequest, stubs.Bank.ConvertCurrencyResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "BankService", "convert"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  stubs.Bank.ConvertCurrencyRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  stubs.Bank.ConvertCurrencyResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<stubs.Bank.ConvertCurrencyRequest,
      stubs.Bank.ConvertCurrencyResponse> getGetCurrencyStreamMethod;
  ...
  public static io.grpc.MethodDescriptor<stubs.Bank.ConvertCurrencyRequest,
      stubs.Bank.ConvertCurrencyResponse> getGetCurrencyStreamMethod() {
    io.grpc.MethodDescriptor<stubs.Bank.ConvertCurrencyRequest, stubs.Bank.ConvertCurrencyResponse> getGetCurrencyStreamMethod;
  ...
  private static volatile io.grpc.MethodDescriptor<stubs.Bank.ConvertCurrencyRequest,
      stubs.Bank.ConvertCurrencyResponse> getPerformCurrencyStreamMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "performCurrencyStream",
      requestType = stubs.Bank.ConvertCurrencyRequest.class,
      responseType = stubs.Bank.ConvertCurrencyResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
  public static io.grpc.MethodDescriptor<stubs.Bank.ConvertCurrencyRequest,
      stubs.Bank.ConvertCurrencyResponse> getPerformCurrencyStreamMethod() {
    io.grpc.MethodDescriptor<stubs.Bank.ConvertCurrencyRequest, stubs.Bank.ConvertCurrencyResponse> getPerformCurrencyStreamMethod;
    if ((getPerformCurrencyStreamMethod = BankServiceGrpc.getPerformCurrencyStreamMethod) == null) {
      synchronized (BankServiceGrpc.class) {
        if ((getPerformCurrencyStreamMethod = BankServiceGrpc.getPerformCurrencyStreamMethod) == null) {
          BankServiceGrpc.getPerformCurrencyStreamMethod = getPerformCurrencyStreamMethod = 
              io.grpc.MethodDescriptor.<stubs.Bank.ConvertCurrencyRequest, stubs.Bank.ConvertCurrencyResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
              .setFullMethodName(generateFullMethodName(
                  "BankService", "performCurrencyStream"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  stubs.Bank.ConvertCurrencyRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  stubs.Bank.ConvertCurrencyResponse.getDefaultInstance()))
                  .setSchemaDescriptor(new BankServiceMethodDescriptorSupplier("performCurrencyStream"))
                  .build();
          }
        }
     }
     return getPerformCurrencyStreamMethod;
  }

  private static volatile io.grpc.MethodDescriptor<stubs.Bank.ConvertCurrencyRequest,
      stubs.Bank.ConvertCurrencyResponse> getFullCurrencyStreamMethod;
  ...
  public static io.grpc.MethodDescriptor<stubs.Bank.ConvertCurrencyRequest,
      stubs.Bank.ConvertCurrencyResponse> getFullCurrencyStreamMethod() {
    io.grpc.MethodDescriptor<stubs.Bank.ConvertCurrencyRequest, stubs.Bank.ConvertCurrencyResponse> getFullCurrencyStreamMethod;
  ...
  public static abstract class BankServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void convert(stubs.Bank.ConvertCurrencyRequest request,
        io.grpc.stub.StreamObserver<stubs.Bank.ConvertCurrencyResponse> responseObserver) {
     ...
     * </pre>
     */
    public void getCurrencyStream(stubs.Bank.ConvertCurrencyRequest request,
        io.grpc.stub.StreamObserver<stubs.Bank.ConvertCurrencyResponse> responseObserver) {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<stubs.Bank.ConvertCurrencyRequest> performCurrencyStream(
        io.grpc.stub.StreamObserver<stubs.Bank.ConvertCurrencyResponse> responseObserver) {
      return asyncUnimplementedStreamingCall(getPerformCurrencyStreamMethod(), responseObserver);
    }
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<stubs.Bank.ConvertCurrencyRequest> fullCurrencyStream(
        io.grpc.stub.StreamObserver<stubs.Bank.ConvertCurrencyResponse> responseObserver) {
          ...
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                ...
                stubs.Bank.ConvertCurrencyResponse>(
          ...
          .addMethod(
            ...
            asyncClientStreamingCall(
              new MethodHandlers<
                stubs.Bank.ConvertCurrencyRequest,
                stubs.Bank.ConvertCurrencyResponse>(
                  this, METHODID_PERFORM_CURRENCY_STREAM)))
          .addMethod(
  ...
  public static final class BankServiceStub extends io.grpc.stub.AbstractStub<BankServiceStub> {
    ...
    public io.grpc.stub.StreamObserver<stubs.Bank.ConvertCurrencyRequest> performCurrencyStream(
      ...
      return asyncClientStreamingCall(
          getChannel().newCall(getPerformCurrencyStreamMethod(), getCallOptions()), responseObserver);
    }
  ...
  public static final class BankServiceBlockingStub extends io.grpc.stub.AbstractStub<BankServiceBlockingStub> {
     ...
     * </pre>
     */
    public stubs.Bank.ConvertCurrencyResponse convert(stubs.Bank.ConvertCurrencyRequest request) {
     ...
     * </pre>
     */
    public java.util.Iterator<stubs.Bank.ConvertCurrencyResponse> getCurrencyStream(
        stubs.Bank.ConvertCurrencyRequest request) {
  ...
  public static final class BankServiceFutureStub extends io.grpc.stub.AbstractStub<BankServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<stubs.Bank.ConvertCurrencyResponse> convert(
        stubs.Bank.ConvertCurrencyRequest request) {
  ...
  private static final int METHODID_PERFORM_CURRENCY_STREAM = 2;
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CONVERT:
          serviceImpl.convert((stubs.Bank.ConvertCurrencyRequest) request,
              (io.grpc.stub.StreamObserver<stubs.Bank.ConvertCurrencyResponse>) responseObserver);
          break;
        case METHODID_GET_CURRENCY_STREAM:
          serviceImpl.getCurrencyStream((stubs.Bank.ConvertCurrencyRequest) request,
              (io.grpc.stub.StreamObserver<stubs.Bank.ConvertCurrencyResponse>) responseObserver);
          break;
        default:
    ...
    public io.grpc.stub.StreamObserver<Req> invoke(
      ...
      switch (methodId) {
        case METHODID_PERFORM_CURRENCY_STREAM:
          return (io.grpc.stub.StreamObserver<Req>) serviceImpl.performCurrencyStream(
              (io.grpc.stub.StreamObserver<stubs.Bank.ConvertCurrencyResponse>) responseObserver);
  ...
  private static abstract class BankServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return stubs.Bank.getDescriptor();
    }
      ...
      synchronized (BankServiceGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              ...
              .addMethod(getPerformCurrencyStreamMethod())
